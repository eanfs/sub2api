...
export interface ConfigFieldDef {
  ...
  hintKey?: string
  options?: TypeOption[]
  /** Render as a multi-line textarea even when the field is not sensitive. */
  multiline?: boolean
}
...
export const METHOD_ORDER = ['alipay', 'alipay_direct', 'wxpay', 'wxpay_direct', 'stripe', 'airwallex', 'antom'] as const
...
export const WEBHOOK_PATHS: Record<string, string> = {
  ...
  antom: '/api/v1/payment/webhook/antom',
}
...
export const PROVIDER_CONFIG_FIELDS: Record<string, ConfigFieldDef[]> = {
  ...
  antom: [
    { key: 'clientId', label: '', sensitive: false, hintKey: 'admin.settings.payment.field_antomClientIdHint' },
    { key: 'merchantPrivateKey', label: '', sensitive: true },
    { key: 'antomPublicKey', label: '', sensitive: false, multiline: true, hintKey: 'admin.settings.payment.field_antomPublicKeyHint' },
    { key: 'keyVersion', label: '', sensitive: false, optional: true, defaultValue: '1', hintKey: 'admin.settings.payment.field_antomKeyVersionHint' },
    { key: 'apiBase', label: '', sensitive: false, defaultValue: 'https://open-sea-global.alipay.com', hintKey: 'admin.settings.payment.field_antomApiBaseHint' },
    { key: 'currency', label: '', sensitive: false, defaultValue: 'CNY', hintKey: 'admin.settings.payment.field_paymentCurrencyHint', options: PAYMENT_CURRENCY_OPTIONS },
    { key: 'settlementCurrency', label: '', sensitive: false, optional: true, clearable: true, hintKey: 'admin.settings.payment.field_antomSettlementCurrencyHint' },
  ],
}

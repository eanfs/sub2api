export default {
    settings: {
      ...
      payment: {
        ...
        field_paymentCurrencyHint: '默认 CNY。Stripe、Airwallex 和 Antom 可按账户支持选择 HKD、USD 等币种；微信、支付宝、易支付仍按 CNY。',
        providerAntom: 'Antom',
        field_merchantPrivateKey: '商户私钥',
        field_antomPublicKey: 'Antom 公钥',
        field_keyVersion: '密钥版本',
        field_settlementCurrency: '结算币种',
        field_antomClientIdHint: '填写 Antom Dashboard 中的 Client ID；沙箱与生产使用各自的 Client ID 和密钥。',
        field_antomPublicKeyHint: '填写 Antom 提供的 RSA 公钥（不是商户公钥），支持 PEM 或 Base64 DER。',
        field_antomKeyVersionHint: '签名使用的商户密钥版本，默认 1。',
        field_antomApiBaseHint: '选择商户所在地区的官方网关：亚洲 open-sea-global.alipay.com、北美 open-na-global.alipay.com、欧洲 open-de-global.alipay.com；美国商户使用 open.antglobal-us.com。必须使用 HTTPS，不含 API 路径。',
        field_antomSettlementCurrencyHint: '仅签约多个结算币种时填写三位币种代码；留空使用商户默认结算币种。',
        antomGuideSummary: '使用 Antom 托管收银台，支持卡和钱包；需要先完成商户签约并配置 RSA 密钥。',
        antomGuideNote: '通知地址必须公网可达。系统校验通知签名；卡支付仅在扣款成功后入账，浏览器回跳不代表支付成功。普通查单在五分钟通知等待期后兜底。',

export default {
  ...
  payment: {
    ...
    admin: {
      ...
      forceFinalizeRefund: 'Force finalize',
      orderNo: 'Order No.',
      forceFinalizeRefundTitle: 'Force finalize refund',
      forceFinalizeRefundMessage: 'Use when gateway inquiry cannot reach a conclusion. Confirm in the gateway dashboard whether this refund actually happened, then pick the matching outcome.',
      forceFinalizeRefunded: 'Gateway refunded it (deduct user balance and mark refunded)',
      forceFinalizeNotRefunded: 'Gateway did not refund it (mark failed so it can be retried)',

export default {
    settings: {
      ...
      payment: {
        ...
        field_paymentCurrencyHint: 'Default is CNY. Stripe, Airwallex and Antom support other listed account currencies; WeChat Pay, Alipay and EasyPay remain CNY.',
        providerAntom: 'Antom',
        field_merchantPrivateKey: 'Merchant private key',
        field_antomPublicKey: 'Antom public key',
        field_keyVersion: 'Key version',
        field_settlementCurrency: 'Settlement currency',
        field_antomClientIdHint: 'Use the Client ID from Antom Dashboard. Sandbox and production have separate client IDs and keys.',
        field_antomPublicKeyHint: 'The RSA public key supplied by Antom, not your merchant public key. PEM and Base64 DER are supported.',
        field_antomKeyVersionHint: 'Merchant signing key version. Defaults to 1.',
        field_antomApiBaseHint: 'Official regional HTTPS origin, without an API path: Asia open-sea-global.alipay.com, North America open-na-global.alipay.com, Europe open-de-global.alipay.com; US merchants use open.antglobal-us.com.',
        field_antomSettlementCurrencyHint: 'Optional three-letter code for merchants with multiple settlement currencies. Leave empty for the merchant default.',
        antomGuideSummary: 'Antom hosted checkout supports cards and wallets. Complete merchant onboarding and configure RSA keys first.',
        antomGuideNote: 'The notification URL must be publicly reachable. Notifications are signature-verified; card payments are credited only after capture. Browser redirects are not proof of payment. Inquiry is a fallback after a five-minute notification grace period.',

...
func init() {
	...
	// paymentorderDescProviderRefundID is the schema descriptor for provider_refund_id field.
	paymentorderDescProviderRefundID := paymentorderFields[26].Descriptor()
	// paymentorder.ProviderRefundIDValidator is a validator for the "provider_refund_id" field. It is called by the builders before save.
	paymentorder.ProviderRefundIDValidator = paymentorderDescProviderRefundID.Validators[0].(func(string) error)

...
var providerSensitiveConfigFields = map[string]map[string]struct{}{
	...
	payment.TypeAntom:     {"merchantprivatekey": {}},
}
...
var providerPendingOrderProtectedConfigFields = map[string]map[string]struct{}{
	...
	payment.TypeAntom:     {"clientid": {}, "merchantprivatekey": {}, "antompublickey": {}, "keyversion": {}, "apibase": {}, "currency": {}, "settlementcurrency": {}},
}
...
var validProviderKeys = map[string]bool{
	payment.TypeEasyPay: true, payment.TypeAlipay: true, payment.TypeWxpay: true, payment.TypeStripe: true, payment.TypeAirwallex: true, payment.TypeAntom: true,
}
